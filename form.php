...
<head>
  ...
  function validateForm() {
    ...
    var values = new Array(firstName,          lastName,         userName,         password,         street,        city,          province,         country,        email);
    var fieds = new Array ('#inputFirstName', '#inputLastName', '#inputUserName', '#inputPassword', '#inputStreet', '#inputCity', '#inputProvince', '#inputCountry', '#inputEmail');
    var msgs = new Array ('first name',         'last name',      'user name',       'password',      'street address', 'city',     'province',      'country',         'email');
    ...
    <div class="col-9">
      <form action="bouncer.php" id="userForm" method="post">
        ...
        <div class="row">
          ...
          <div class="col-7">
            <input name="businessPhone" type="number" id="inputBusinessPhone">
          </div>
        </div>
        <div class="row">
          <div class="col-5">
            <input type="submit" value="Submit" style="display:block; float:right;">
          </div>
          <div class="col-7">
